                                ...
                                <div class="product-item notebooks">
                                    <div class="product discount product_filter">
                                        ...
                                        <div class="product_info">
                                            <h6 class="product_name"><a href="single.php"><?php echo htmlspecialchars($row['name']); ?></a></h6>
                                            <div class="product_price"><?php echo htmlspecialchars($row['price']); ?><span><?php echo htmlspecialchars($row['price'] + 5); ?></span></div>
                                        </div>
                                    </div>
                                    <div class="red_button add_to_cart_button">
                                    <a href="#" 
                                    onclick="addToCart('<?php echo addslashes($row['name']); ?>',<?php echo (float)$row['price']; ?>,'<?php echo addslashes($row['image']); ?>' , 'uploads/')">add to cart</a>
                                    </div>
                                </div>
                                <?php
                                    }
