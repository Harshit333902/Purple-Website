...
<div class="super_container">
							...
							<ul class="top_nav_menu">
								...
								<li class="account">
									...
									<ul class="account_selection">
										<li><a href="logout.php"><i class="fa fa-sign-in" aria-hidden="true"></i>Sign Out</a></li>
   ...
   <!-- Cart Section -->
    ...
    <!-- Booking Section -->
    <div class="container mt-5" id="bookingSection" style="display:none;">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="order-summary">
                    ...
                    <p class="total-price"><strong>Total: $9.98</strong></p>
    ...
    <script>
        // Cart items and Razorpay integration
            ...
            savedCartItems.forEach((item, index) => {
                ...
                cartItem.innerHTML = `
                    <div class="cart-item-content d-flex">
                        <img src="${item.image}" alt="${item.name}" class="cart-item-image" style="width: 100%; height: auto;"  onerror="this.onerror=null; this.src='images/fallback.png';">
        ...
        // Toggle Cart to Booking Section
