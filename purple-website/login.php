    ...
    <div class="forms-container">
        ...
        <div class="admin-login-form" style="display: none;">
            ...
            <form action="admin_dashboard.php" method="POST">
                ...
                <p class="toggle-form">Go back to <span id="switch-to-user-login-admin">User Login</span></p>
            </form>
        </div>
...
document.getElementById('switch-to-user-login-admin').addEventListener('click', function() {
